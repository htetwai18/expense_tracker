  ...
  Widget build(BuildContext context) {
    return Consumer<AppProvider>(
      builder: (context, appProvider, child) {
        ...
        final recentEntries = appProvider.recentTransactions;
          ...
          child: Column(
            ...
            children: [
              const AppHeader(
                ...
                leading: CircleTextButton(label: AppStrings.back),
              ),
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final category = appProvider.categoryById(entry.categoryId);
